...
class NY_OG_Main_Admin {
  ...
  static public function init() {
    ...
    if (!is_array(self::$options)) {
      self::$options = array(
          'blog_title' => stripslashes(get_bloginfo('name')),
		  'home_title' => stripslashes(get_bloginfo('name')),
		  'blog_type' => 'blog',
		  'home_type' => 'website',
          'blog_description' => stripslashes(get_bloginfo('description')),
          'home_description' => stripslashes(get_bloginfo('description')),
      );
    }
