    ...
    '$scope', '$http', function($scope, $http) {
      ...
      jQuery('#date').datepicker({
        ...
        beforeShowDay: function(date) {
          var availability, availableDates, check, checkDate, eventDate, i, len, ref, savedDate;
          ...
          if (typeof $scope.monthEvents !== 'undefined') {
            ...
            check = function(eventDate) {
              var DateString, _Day, _Month, _Year, _availability, _eventDay, _eventMonth, _eventYear, eventDateString;
