...
function beyond_load_scripts() {
    ...
    wp_register_script('main_js', ltrim(get_template_directory_uri(),'').'/main.min.js', null ,'2024..11.28', false);
...
{
  wp_enqueue_style( 'beyond_style', ltrim(get_stylesheet_uri(),'https:'),'','2024.11.19','all' );
}
