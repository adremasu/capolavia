		...
		<div id="optionsframework" class="postbox">
					...
					<tr>
						...
						<td>
							<div class="accesspress_ray_fav_icon">
							  ...
							  <input class="button" name="media_upload_button" id="accesspress_ray_media_upload_button" value="<?php _e('Upload','accesspress-ray'); ?>" type="button" /> <br />
							  ...
							  <div id="accesspress_ray_fav_icon_remove"><?php _e('Remove','accesspress-ray'); ?></div>
							  </div>
							  <?php }else{ ?>
							  ...
							  <a href="javascript:void(0)" id="accesspress_ray_fav_icon_remove" title="remove"><?php _e('Remove','accesspress-ray'); ?></a>
							  </div>
							  <?php	} ?>
							</div>
						</td>
			...
			<h3><?php _e('Know more about AccessPress Themes','accesspress-ray'); ?></h3>
				<table class="form-table">
					<tr>
					<td colspan="2">
						<p><?php _e('AccessPress Ray - is a FREE WordPress theme by','accesspress-ray'); ?> <a target="_blank" href="<?php echo esc_url('http://www.accesspressthemes.com/'); ?>">AccessPress Themes</a> <?php _e('- A WordPress Division of Access Keys.','accesspress-ray'); ?></p>
						<p><?php _e('For demo, click','accesspress-ray'); ?> <a target="_blank" href="<?php echo esc_url('https://accesspressthemes.com/accesspress-ray/'); ?>"><?php _e('here','accesspress-ray'); ?></a></p>
						...
						$other_product .= __('Our Themes - ','accesspress-ray'). __(sprintf('<a href="%s" target="_blank">https://accesspressthemes.com/themes</a>','https://accesspressthemes.com/themes'))."<br><br>" ;
						...
						<?php _e('Forum:','accesspress-ray'); ?> <a href="<?php echo esc_url('http://accesspressthemes.com/support/'); ?>">http://accesspressthemes.com/support</a><br/>
						<br/>
